...
const CACHE_NAME = "districtry-il-shell-v25";
...
const GEOMETRY_URLS = [
  ...
  "./data/app/boone-fire-districts.json",
  ...
  "./data/app/alexander-library-districts.json",
  "./data/app/bond-library-districts.json",
  "./data/app/brown-library-districts.json",
  "./data/app/calhoun-library-districts.json",
  "./data/app/cass-library-districts.json",
  "./data/app/clark-library-districts.json",
  "./data/app/clay-library-districts.json",
  "./data/app/clinton-library-districts.json",
  "./data/app/coles-library-districts.json",
  "./data/app/crawford-library-districts.json",
  "./data/app/cumberland-library-districts.json",
  "./data/app/dewitt-library-districts.json",
  "./data/app/douglas-library-districts.json",
  "./data/app/edgar-library-districts.json",
  "./data/app/edwards-library-districts.json",
  "./data/app/franklin-library-districts.json",
  "./data/app/fulton-library-districts.json",
  "./data/app/gallatin-library-districts.json",
  "./data/app/greene-library-districts.json",
  "./data/app/hamilton-library-districts.json",
  "./data/app/hancock-library-districts.json",
  "./data/app/hardin-library-districts.json",
  "./data/app/henry-library-districts.json",
  "./data/app/iroquois-library-districts.json",
  "./data/app/jackson-library-districts.json",
  "./data/app/jefferson-library-districts.json",
  "./data/app/jersey-library-districts.json",
  "./data/app/jo-daviess-library-districts.json",
  "./data/app/johnson-library-districts.json",
  "./data/app/knox-library-districts.json",
  "./data/app/lasalle-library-districts.json",
  "./data/app/livingston-library-districts.json",
  "./data/app/logan-library-districts.json",
  "./data/app/marshall-library-districts.json",
  "./data/app/mason-library-districts.json",
  "./data/app/massac-library-districts.json",
  "./data/app/mcdonough-library-districts.json",
  "./data/app/mclean-library-districts.json",
  "./data/app/menard-library-districts.json",
  "./data/app/mercer-library-districts.json",
  "./data/app/monroe-library-districts.json",
  "./data/app/montgomery-library-districts.json",
  "./data/app/morgan-library-districts.json",
  "./data/app/moultrie-library-districts.json",
  "./data/app/ogle-library-districts.json",
  "./data/app/perry-library-districts.json",
  "./data/app/pike-library-districts.json",
  "./data/app/pulaski-library-districts.json",
  "./data/app/putnam-library-districts.json",
  "./data/app/richland-library-districts.json",
  "./data/app/saline-library-districts.json",
  "./data/app/schuyler-library-districts.json",
  "./data/app/scott-library-districts.json",
  "./data/app/shelby-library-districts.json",
  "./data/app/tazewell-library-districts.json",
  "./data/app/union-library-districts.json",
  "./data/app/vermilion-library-districts.json",
  "./data/app/wabash-library-districts.json",
  "./data/app/warren-library-districts.json",
  "./data/app/washington-library-districts.json",
  "./data/app/wayne-library-districts.json",
  "./data/app/white-library-districts.json",
