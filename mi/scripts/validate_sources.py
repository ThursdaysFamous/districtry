...
PROVENANCE = [
    ...
    },
    {
        ...
        "note": (
            ...
            "(ac140f8d81b94edc804e34470308c865, shared public, licenseInfo empty) NOT from the "
            "service root's own serviceItemId, which exists (bc724227..., baa80629...) and "
            "does NOT resolve on arcgis.com -- those are ids in the city's own portal, so "
            "following the root would read a licence from an error envelope. Currency is gated "
