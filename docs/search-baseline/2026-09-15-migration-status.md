...
- **Static officeholder tables** for Chicago wards (50), NYC council (51) and SF supervisors
  (11), dated, with `Person` markup. The per-county board pages already do this for 2,650
  county seats in four states; these three rosters are the gap.
