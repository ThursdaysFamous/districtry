...
| `il-supreme-court` | your Supreme Court district AND your Appellate Court branch | State (judicial) | district (5) | DONE · appellate row DONE 2026-09-15 as card rows, not a layer — the two courts share one set of districts by law |
