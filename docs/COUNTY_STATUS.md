...
| Cass | 17017 | dispatch | districted | `county-board`, `county-precinct` | 2 — `library-districts-unmapped-counties` (no-source); `pass9-ward-seats-without-maps` (no-source) |
...
| Clay | 17025 | dispatch | districted | `county-board` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| De Witt | 17039 | dispatch | districted | `county-board`, `county-precinct` | 2 — `dewitt-township-officials` (data-quality); `library-districts-unmapped-counties` (no-source) |
...
| Douglas | 17041 | dispatch | districted | `county-board`, `county-precinct` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| Edgar | 17045 | dispatch | districted | `county-board`, `county-precinct` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| Henry | 17073 | dispatch | districted | `county-board`, `county-precinct` | 2 — `library-districts-unmapped-counties` (no-source); `pass9-ward-seats-without-maps` (no-source) |
| Iroquois | 17075 | dispatch | districted | `county-board`, `county-precinct`, `fire-district` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| LaSalle | 17099 | dispatch | districted | `county-board`, `county-precinct` | 5 — `lasalle-board-districts-stale` (no-source); `lasalle-municipal-wards` (no-source); `library-districts-unmapped-counties` (no-source); `ogle-lasalle-special-districts` (no-source); `wenona-two-clerks-disagree` (data-quality) |
...
| Livingston | 17105 | dispatch | districted | `county-board` | 3 — `library-districts-unmapped-counties` (no-source); `livingston-precincts` (no-source); `livingston-special-districts` (no-source) |
...
| McDonough | 17109 | dispatch | districted | `county-board`, `county-precinct` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| McLean | 17113 | dispatch | districted | `county-board`, `county-precinct` | 2 — `library-districts-unmapped-counties` (no-source); `mclean-special-districts` (no-source) |
| Menard | 17129 | dispatch | districted | `county-board`, `county-precinct` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| Ogle | 17141 | dispatch | districted | `county-board`, `county-precinct` | 3 — `library-districts-unmapped-counties` (no-source); `ogle-lasalle-special-districts` (no-source); `ogle-municipal-wards` (no-source) |
...
| Tazewell | 17179 | dispatch | districted | `county-board`, `county-precinct` | 1 — `library-districts-unmapped-counties` (no-source) |
...
| Warren | 17187 | dispatch | districted | `county-board`, `county-precinct` | 2 — `library-districts-unmapped-counties` (no-source); `pass10-frontier-unasked` (no-source) |
| Washington | 17189 | dispatch | districted | `county-board` | 2 — `library-districts-unmapped-counties` (no-source); `washington-precinct-geometry` (no-source) |
...
| Whiteside | 17195 | dispatch | districted | `county-board`, `county-precinct` | 5 — `library-districts-unmapped-counties` (no-source); `whiteside-municipal-officials` (no-source); `whiteside-precinct-polling` (data-quality); `whiteside-special-district-boards` (no-source); `whiteside-special-districts` (blocked) |
...
| Winnebago | 17201 | dispatch | districted | `county-board`, `county-precinct`, `judicial-subcircuit` | 3 — `library-districts-unmapped-counties` (no-source); `rockford-city-precincts` (no-source); `winnebago-special-districts` (no-source) |
